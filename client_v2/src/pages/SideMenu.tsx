...
export default function SideMenu () {
  ...
  return (
    <>
        <nav className="fixed top-0 z-50 w-full bg-yomiko-red border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700">
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center justify-start rtl:justify-end">
                  ...
                  <a href="/" className="flex ms-2 md:me-24">
                    ...
                    <span className="self-center text-white text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">Yomiko</span>
                  </a>
                </div>
              </div>
          </div>
        </nav>
        <aside id="logo-sidebar" className={`fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-${showMenu ? '1/6' :'full'} bg-white border-r border-gray-200 sm:translate-x-0 dark:bg-gray-800 dark:border-gray-700`} aria-label="Sidebar">
          <div className="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
              <ul className="space-y-2 font-medium">
                ...
                <li>
                    <a href="/study" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                      ...
                      <span className="flex-1 ms-3 whitespace-nowrap">Study</span>
                    </a>
                </li>
                <li>
                    <a href="/exam" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                      ...
                      <span className="flex-1 ms-3 whitespace-nowrap">Mock exam</span>
                    </a>
                </li>
                <li>
                    <a href="/statistics" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
              ...
              <div id="dropdown-cta" className="p-4 mt-6 rounded-lg bg-blue-50 dark:bg-blue-900" role="alert">
                ...
                <p className="mb-3 text-sm text-blue-800 dark:text-blue-400">
                  Yomiko is still in beta development, things can break, small and big changes can happen over night. Thank you for your patience and participation in the beta phase.
                </p>
              </div>
          </div>
        </aside>
