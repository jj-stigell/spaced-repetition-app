  ...
  return (
   ...
   <div className="grid grid-cols-2 grid-rows-3 md:grid-rows-4 md:grid-cols-4 gap-2 md:gap-4 h-screen">
      ...
      <h2 className="flex flex-row flex-nowrap items-center mb-2">
                <span className="flex-grow block border-t border-yomiko-red" aria-hidden="true" role="presentation"></span>
      ...
      <ul>
                     <li className="mb-2">
                        <article className="container bg-white shadow-xl rounded-xl p-5 transform transition duration-800 hover:scale-105">
                           <h1 className="font-bold text-yomiko-red">10 tips how to prepare for JLPT</h1>
                           <p className="font-light text-gray-500">It is less than one month until the JLPT exam day. Take these 10 tips for you in the test. Concentrate on reviewing the grammar points, vocabulary, and kanji you find most challenging. It's crucial to reinforce weak areas in this final stretch...</p>
                           <h6 className="text-sm text-gray-300 mb-5">Published 12/11/2022</h6>
                           <a href="/article/937623" className="rounded-lg py-2 px-4 text-center text-white bg-yomiko-red hover:bg-red-800">Read article</a>
                        </article>
                     </li>
                     <li className="mb-2">
                        <article className="container bg-white shadow-xl rounded-2xl p-5 transform transition duration-800 hover:scale-105">
                           <h1 className="font-bold text-yomiko-red">Why RTK Is a magnificent way to learn kanji</h1>
                           <p className="font-light text-gray-500">James Heisig's Remembering the Kanji is undeniably the best way to learn and remember massive amount of kanji characters in the shortest possible time frame. After this article you too can harness the power of mnemonics to...</p>
                           <h6 className="text-sm text-gray-300 mb-5">Published 08/10/2022</h6>
                           <a href="/article/9459340" className="rounded-lg py-2 px-4 text-center text-white bg-yomiko-red hover:bg-red-800">Read article</a>
                        </article>
                     </li>
                     <li className="mb-2">
                        <article className="container bg-white shadow-xl rounded-2xl p-5 transform transition duration-800 hover:scale-105">
