...
const KanjiFront = ({ data, handleAnswerSelect, getButtonClasses, showCardBack }: PropsKanjiFront) => {
    return (
        <>
...
const VocabularyFront = ({ data, handleAnswerSelect, getButtonClasses, handleAnswerSubmit, showCardBack }: PropsVocabularyFront) => {
    ...
    const addCharFromKeyboard = (char: string) => {
...
export default function CardFront ({ data, showCardBack, setShowCardBack }: Props) {
    ...
    const handleAnswerSubmit = (value: string, correctValue: string) => {
