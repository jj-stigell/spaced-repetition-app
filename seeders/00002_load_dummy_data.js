...
const account_card_custom_data = fs.readFileSync(path.resolve(__dirname, '../setup/database/data/account_card_custom_data.sql'), 'utf8');
...
module.exports = {
  up: async ({ context: queryInterface }) => {
    ...
    try {
      ...
      if (NODE_ENV !== 'production') {
        console.log('Not in production, loading dummy review data');
        ...
        await queryInterface.sequelize.query(account_card_custom_data, { transaction });
      }
  ...
  down: async ({ context: queryInterface }) => {
    ...
    try {
      ...
      await queryInterface.bulkDelete('account_card_custom_data', {}, { transaction });
