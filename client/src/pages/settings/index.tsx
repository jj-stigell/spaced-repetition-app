...
<div className="min-h-screen max-w-screen-xl">
  ...
  <div className="grid grid-cols-8 pt-3 sm:grid-cols-10">
    ...
    <div className="col-span-8 overflow-hidden rounded-xl bg-white shadow-xl sm:px-8 sm:shadow">
      ...
      <p className="mt-4">Can&apos;t remember your current password? Logout and request password resetting from signin view</p>
      ...
      <div className="mb-10">
        ...
        <p className="mt-1">Logout from current account, remember to clear cache if you are using public access to use Yomiko</p>


        <button disabled={loggingOut} onClick={handleLogout} className="my-2 rounded-lg bg-blue-600 px-4 py-2 text-white">Logout</button>
        ...
        <button className="ml-auto text-sm font-semibold text-rose-600 underline decoration-2 hover:text-rose-800">Continue with deletion</button>
      </div>
    </div>
  </div>
</div>
